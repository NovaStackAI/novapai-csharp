...
> Use NovaPAI in C# — OpenAI-compatible API gateway for DeepSeek V4 Pro & 50+ LLMs. Change one line of code, switch to any model.

[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![API](https://img.shields.io/badge/API-NovaPAI-6C47FF)](https://novapai.ai)
[![C#](https://img.shields.io/badge/C%23-SDK-brightgreen)](#)
...
```bash
git clone https://github.com/NovaStackAI/novapai-csharp.git
cd novapai-csharp
...
All examples are in `Program.cs`:
